    ...
    internal sealed class Configuration : DbMigrationsConfiguration<TechnologyUniversity.Models.UniversityContext>
    {
        ...
        protected override void Seed(TechnologyUniversity.Models.UniversityContext context)
        {
...

            {
                new Teacher
                {
                    Name = "Mijan Mia" , Address = "Dhaka" , ContactNo = "01930823391", 
                    Email = "m@gmail.com" , CreditTaken = 15 , DesignationId = 1 , DepartmentId = 1
                },
                new Teacher
                {
                    Name = "Korim Mia" , Address = "Dhaka" , ContactNo = "01930823391", 
                    Email = "Korim@gmail.com" , CreditTaken = 15 , DesignationId = 1 , DepartmentId = 1
                },
                new Teacher
                {
                    Name = "Rohim Mia" , Address = "Dhaka" , ContactNo = "01930823391", 
                    Email = "Rohim@gmail.com" , CreditTaken = 15 , DesignationId = 1 , DepartmentId = 2
                },
                 new Teacher
                {
                    Name = "jamal Mia" , Address = "Dhaka" , ContactNo = "01930823391", 
                    Email = "jamal@gmail.com" , CreditTaken = 15 , DesignationId = 1 , DepartmentId = 2
                },
                 new Teacher
                {
                    Name = "Kamal Mia" , Address = "Dhaka" , ContactNo = "01930823391", 
                    Email = "Kamal@gmail.com" , CreditTaken = 15 , DesignationId = 1 , DepartmentId = 3
                },
                 new Teacher
                {
                    Name = "Sojol Mia" , Address = "Dhaka" , ContactNo = "01930823391", 
                    Email = "Sojol@gmail.com" , CreditTaken = 15 , DesignationId = 1 , DepartmentId = 3
                }
